...
(function() {
    ...
    const config = {
        triggerKeyword: '小奇',
        storageKey: 'xiaoqi_keywords_v3',
        searchHistoryKey: 'xiaoqi_search-history',
        inviteCodeKey: 'xiaoqi_invite-code',
   ...
   /*   function addStyles() {
        ...
        const styles = `
            ...
            .xiaoqi-mouth { width: 16px; height: 6px; background: #2f3542; border-radius: 8px 8px 8px 8px; margin-top: 2px; }
            ...
            .panel-btn { flex: 1; padding: 8px; border-radius: 4px; border: none; cursor: pointer; font-size: 12px; color: white; }
...
@media screen and (max-width: 480px) {
    ...
    const styles = `
        ...
        .stats-section, .keywords-section { 
            padding: 12px 16px; 
    ...
    function interceptSearchFunction() {
        if (typeof window.performSearch === 'function') {
            ...
            window.performSearch = function() {
                ...
                // 检测结果：直接看 DOM 中有没有 .revealed 类的元素
   ...
   /*  function showPeriodicHint() {
    ...
    function showPeriodicHint() {
        const hints = [
            "1、姨姨的姓氏你搜了吗！不要只搜姓！姓氏姓氏！姓+氏！",
            "2、喂，你不会没有搜过临渠县那个啥东西吧？咋跟你说呢！金桂那篇报道里有的啊！",
            "3、有个鸟类你搜了吗？两个字的!听起来像是晚上会出现的那种鸟",
            "4、你不是费半天劲得了五个字母吗？你搜一下哇",
            "5、那个红蛋组织的拼音首字母简写，大写！",
            "6、lssmr不是有五个字吗，两个三个的拆开！",
            "7、你不觉得那个啥子符很重要吗？不要在这搜！"
        ];
